...
public class AdvancementGoal extends SatisfiableGoal<AdvancementHolder> {
    public AdvancementGoal(String id, NameExtractor nameExtractor, TextureExtractor textureExtractor, List<GoalHint> hints, Pair<String, String> buildData, Predicate<AdvancementHolder> satisfiedPredicate) {
