...
public class ObtainItemGoal extends SatisfiableGoal<Inventory> {
    public ObtainItemGoal(String id, NameExtractor nameExtractor, TextureExtractor textureExtractor, List<GoalHint> hints, Pair<String, String> buildData, Predicate<Inventory> satisfiedPredicate) {
